...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private ConstraintLayout wxl_main_content;
    ...
    private void initView() {
        ...
        wxl_main_content = findViewById(R.id.wxl_main_content);
    ...
    private void initData() {
        mFgManager.beginTransaction().replace(R.id.wxl_main_content, LittleSisterFragment.newInstance(), DryConstant.FG_LITTLE_SISTER).commit();
